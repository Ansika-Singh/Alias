...
const MOCK_TIMETABLE = {
  MONDAY: [
    ...
    { subject: 'DBMS', teacherId: 'Dr. Suresh', startTime: '11:15', endTime: '12:15', section: 'A', semester: 5 },
    { subject: 'Computer Networks', teacherId: 'Prof. Meera', startTime: '14:00', endTime: '15:00', section: 'A', semester: 5 },
  ],
  TUESDAY: [
    { subject: 'Computer Networks', teacherId: 'Prof. Meera', startTime: '09:00', endTime: '10:00', section: 'A', semester: 5 },
    { subject: 'Data Structures Lab', teacherId: 'Dr. Ramesh', startTime: '10:00', endTime: '12:00', section: 'A', semester: 5 },
    { subject: 'Operating Systems', teacherId: 'Prof. Ananya', startTime: '14:00', endTime: '15:00', section: 'A', semester: 5 },
  ],
  WEDNESDAY: [
    { subject: 'DBMS', teacherId: 'Dr. Suresh', startTime: '09:00', endTime: '10:00', section: 'A', semester: 5 },
    { subject: 'Data Structures', teacherId: 'Dr. Ramesh', startTime: '10:00', endTime: '11:00', section: 'A', semester: 5 },
    { subject: 'DBMS Lab', teacherId: 'Dr. Suresh', startTime: '11:15', endTime: '13:15', section: 'A', semester: 5 },
  ],
  THURSDAY: [
    { subject: 'Operating Systems', teacherId: 'Prof. Ananya', startTime: '09:00', endTime: '10:00', section: 'A', semester: 5 },
    { subject: 'Computer Networks', teacherId: 'Prof. Meera', startTime: '10:00', endTime: '11:00', section: 'A', semester: 5 },
    { subject: 'Data Structures', teacherId: 'Dr. Ramesh', startTime: '11:15', endTime: '12:15', section: 'A', semester: 5 },
    { subject: 'Seminar', teacherId: 'Prof. Ananya', startTime: '14:00', endTime: '15:00', section: 'A', semester: 5 },
  ],
  FRIDAY: [
    { subject: 'CN Lab', teacherId: 'Prof. Meera', startTime: '09:00', endTime: '11:00', section: 'A', semester: 5 },
    { subject: 'DBMS', teacherId: 'Dr. Suresh', startTime: '11:15', endTime: '12:15', section: 'A', semester: 5 },
    { subject: 'Operating Systems', teacherId: 'Prof. Ananya', startTime: '14:00', endTime: '15:00', section: 'A', semester: 5 },
  ],
  SATURDAY: [
    { subject: 'Sports / Extra-curricular', teacherId: 'Coordinator', startTime: '09:00', endTime: '11:00', section: 'A', semester: 5 },
  ],
};
